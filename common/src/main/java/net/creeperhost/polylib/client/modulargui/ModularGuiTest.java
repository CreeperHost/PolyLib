...
public class ModularGuiTest implements GuiProvider, DynamicTextures {
    ...
    public void makeTextures(Function<DynamicTexture, String> textures) {
        BACKGROUND_TEXTURE = dynamicTexture(textures, new ResourceLocation(PolyLib.MOD_ID, "textures/gui/dynamic/gui_vanilla"), new ResourceLocation(PolyLib.MOD_ID, "textures/gui/test_gui"), 200, 200, 4);
    }
    ...
    public void buildGui(ModularGui gui) {
        ...
        gui.setGuiTitle(new TextComponent("Hello World!"));
        ...
        textField.primary
                .setSuggestion(new TextComponent("I suggest you type something!"))
                .setMaxLength(1000);
...
//        guiList.addHiddenScrollBar();
        ...
        progressRight.setTooltipSingle(() -> new TextComponent(((int) (progressRight.getProgress() * 100)) + "%"));
...
//        Fast-er
        ...
        for (int i = 0; i < 100; i++) {
            int finalI = i;
            lastButton = GuiButton.vanillaAnimated(content, new TextComponent("Button " + i), () -> System.out.println("Click " + finalI))
            ...
            lastButton.setTooltip(new TextComponent("Button Tool Tip " + i));


            GuiButton finalLastButton = lastButton;
//            new GuiItemStack(lastButton, new ItemStack(itemList.get(random.nextInt(itemList.size()))))
            new GuiItemStack(lastButton, new ItemStack(Registry.ITEM.getRandom(random).orElse(Items.BARRIER.builtInRegistryHolder())))
