...
public class GuiColourPicker extends GuiManipulable {
    ...
    /**
     * @param guiParent Can be any element. Used only as a way to get the root element from the {@link net.creeperhost.polylib.client.modulargui.ModularGui}
     */
    ...
    public static GuiColourPicker create(GuiParent<?> guiParent, ColourState colourState, boolean hasAlpha) {
        ...
        picker.cancelButton = GuiButton.flatColourButton(background, () -> new TranslatableComponent("gui.cancel"), e -> 0xFF000000, e -> e ? 0xFF777777 : 0xFF555555)
                .setOpaque(true)
                .onPress(() -> {
        ...
        picker.okButton = GuiButton.flatColourButton(background, () -> new TranslatableComponent("gui.ok"), e -> 0xFF000000, e -> e ? 0xFF777777 : 0xFF555555)
                .setOpaque(true)
