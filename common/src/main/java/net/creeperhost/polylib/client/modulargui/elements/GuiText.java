...
public class GuiText extends GuiElement<GuiText> implements ForegroundRender {
    ...
    public GuiText autoHeight() {
        constrain(GeoParam.HEIGHT, dynamic(() -> wrap ? (double) font().wordWrapHeight(getText() == null ? "" : getText().getString(), (int) xSize()) : font().lineHeight));
        return this;
    }
    ...
    public void renderInFront(GuiRender render, double mouseX, double mouseY, float partialTicks) {
        ...
        //Draw Trimmed
        if (tooLong && getTrim()) {
            Component tail = new TextComponent("...").setStyle(getText().getStyle());
        ...
        //Draw Wrapped
            ...
            textHeight = font.wordWrapHeight(component.getString(), (int) xSize());
