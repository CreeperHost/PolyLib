...
public class TextInputDialog extends GuiElement<TextInputDialog> {
    ...
    public static TextInputDialog simpleDialog(GuiElement<?> parent, Component title, String defaultText) {
        ...
        GuiButton accept = GuiButton.flatColourButton(dialog, () -> new TranslatableComponent("gui.ok"), hovered -> hovered ? 0xFF44AA44 : 0xFF118811)
        ...
        GuiButton cancel = GuiButton.flatColourButton(dialog, () -> new TranslatableComponent("gui.cancel"), hovered -> hovered ? 0xFFAA4444 : 0xFF881111)
