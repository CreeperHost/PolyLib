...
public class CursorHelper {
    ...
    public static final ResourceLocation DRAG = new ResourceLocation(PolyLib.MOD_ID, "textures/gui/cursors/drag.png");
    public static final ResourceLocation RESIZE_H = new ResourceLocation(PolyLib.MOD_ID, "textures/gui/cursors/resize_h.png");
    public static final ResourceLocation RESIZE_V = new ResourceLocation(PolyLib.MOD_ID, "textures/gui/cursors/resize_v.png");
    public static final ResourceLocation RESIZE_TRBL = new ResourceLocation(PolyLib.MOD_ID, "textures/gui/cursors/resize_diag_trbl.png");
    public static final ResourceLocation RESIZE_TLBR = new ResourceLocation(PolyLib.MOD_ID, "textures/gui/cursors/resize_diag_tlbr.png");
