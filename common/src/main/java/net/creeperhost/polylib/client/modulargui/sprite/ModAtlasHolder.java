package net.creeperhost.polylib.client.modulargui.sprite;//package net.creeperhost.polylib.client.modulargui.sprite;
//
...
////        pendingStitchResults.pendingStitches.forEach((pendingStitch) -> pendingStitch.entry.scheduleLoad(resourceManager, executor, this.maxMipmapLevels).whenComplete((preparations, throwable) -> {
...
////
////        }));
////        CompletableFuture var10000 = pendingStitchResults.allReadyToUpload;
////        Objects.requireNonNull(preparationBarrier);
////        return var10000.thenCompose(preparationBarrier::wait).thenAcceptAsync((object) -> this.materialLookup = pendingStitchResults.joinAndUpload(), executor2);
//
