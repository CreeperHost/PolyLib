...
public record WrappedBlockEnergyContainer(BlockEntity blockEntity, PolyEnergyContainer container) implements PolyEnergyContainer, Updatable<BlockEntity>
{
    @Override
    ...
    {
        object.setChanged();
        object.getLevel().sendBlockUpdated(object.getBlockPos(), object.getBlockState(), object.getBlockState(),
                Block.UPDATE_ALL);
    }
