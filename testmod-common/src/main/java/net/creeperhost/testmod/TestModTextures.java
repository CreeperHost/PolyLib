...
public class TestModTextures
{
    ...
    public static final Identifier TEXTURE_ID = Identifier.fromNamespaceAndPath(TestModCommon.MOD_ID, "textures/atlas/gui.png");
    public static final Identifier DEFINITION_LOCATION = Identifier.fromNamespaceAndPath(TestModCommon.MOD_ID, "gui");
