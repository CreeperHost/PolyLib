...
public class MainMenuGuiInjection implements GuiProvider {
    ...
    public void buildGui(ModularGui gui) {
        ...
        var testField = GuiTextField.create(root, 0xFF000000, 0xFF606060, 0xFFFFFFFF);
        testField.primary.setSuggestion(Component.literal("Suggestion?"));
        Constraints.size(testField.container, 100, 20);
        Constraints.placeInside(testField.container, root, Constraints.LayoutPos.MIDDLE_LEFT, 10, 0);
